...
#: (ADR-0002, three times: retiring L2', publishing the per-language accuracy table, and
#: recording the gating exposure it exposed).
#:
#: Seven re-pins in two days is itself the finding. ADR-0002 is gold for the resolution
#: commits and it has roughly doubled in length, so P@1 has climbed from 0.377 to 0.491
